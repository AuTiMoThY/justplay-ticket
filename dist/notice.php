...
<html lang="zh-Hant">
    ...
    <!-- 頁面內容  START-->
    <!-- =========================================================================-->
    <main class="page_main page-notice">
        
        <section class="page_section notice_main">
            <div class="page_section-inner">
    <div class="page_section-content container">
        <div class="notice_main-wrapper">
            <div class="page_section-hd notice_main-hd">
                <h2 class="title">
                    <span class="image_replacement text-hide" style="background-image: url(./assets/images/image_replacement-notice.svg)">
                        NOTICE
                    </span>
                </h2>
                <div class="subtitle">
                    ...
                    <span class="txt">購買須知</span>
                </div>
            </div>
            <div id="pagesWrapper" class="page_section-bd notice_main-bd pages-wrapper">
                    ...
                    <div class="pages-aside-inner">
                        <ul class="pages-aside-list lis-n">
                            ...
                            <li class="pages-aside-item js-active">
                                <a href="javascript:;" class="link justplayTicket_btn justplayTicket_btn-style1">預購說明</a>
                            </li>
                            <li class="pages-aside-item">
                                <a href="javascript:;" class="link justplayTicket_btn justplayTicket_btn-style1">付款方式</a>
                            </li>
                            <li class="pages-aside-item">
                                <a href="javascript:;" class="link justplayTicket_btn justplayTicket_btn-style1">寄送方式</a>
                            </li>
                        </ul>
                    </div>
                </aside>
                <main class="pages-main">
                    <h3 class="pages-main-title">預購說明</h3>
