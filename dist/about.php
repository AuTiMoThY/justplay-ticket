...
<html lang="zh-Hant">
    ...
    <!-- 頁面內容  START-->
    <!-- =========================================================================-->
    <main class="page_main page-about">
        
        <section class="page_section about_main">
            <div class="page_section-inner">
    <div class="page_section-content container">
        <div class="about_main-wrapper">
            <div class="page_section-hd about_main-hd">
                <h2 class="title">
                    <span class="image_replacement text-hide" style="background-image: url(./assets/images/image_replacement-about.svg)">
                        ABOUT
                    </span>
                </h2>
                <div class="subtitle">
            ...
            <div id="pagesWrapper" class="page_section-bd about_main-bd pages-wrapper">
                    ...
                    <div class="pages-aside-inner">
                        <ul class="pages-aside-list lis-n">
                            ...
                            <li class="pages-aside-item js-active">
                                <a href="about.php" class="link justplayTicket_btn justplayTicket_btn-style1">商店介紹</a>
                            </li>
                            <li class="pages-aside-item">
                                <a href="about.php" class="link justplayTicket_btn justplayTicket_btn-style1">門市資訊</a>
                            </li>
                            <li class="pages-aside-item">
                                <a href="about.php" class="link justplayTicket_btn justplayTicket_btn-style1">經營理念</a>
                            </li>
                            <li class="pages-aside-item">
                                <a href="about.php" class="link justplayTicket_btn justplayTicket_btn-style1">隱私權條款</a>
                            </li>
                            <li class="pages-aside-item">
                                <a href="about.php" class="link justplayTicket_btn justplayTicket_btn-style1">會員條款</a>
                            </li>
                        </ul>
                    </div>
                </aside>
                <main class="pages-main">
                    <h3 class="pages-main-title">商店介紹</h3>
